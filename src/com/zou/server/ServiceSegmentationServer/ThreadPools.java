package com.zou.server.ServiceSegmentationServer;
...
public class ThreadPools {
    ...
    public static void setRead_httpRequest_Pool(ThreadPoolExecutor read_httpRequest_Pool) {
        ThreadPools.read_httpRequest_Pool = read_httpRequest_Pool;
    }

    public static void setRead_file_Pool(ThreadPoolExecutor read_file_Pool) {
        ThreadPools.read_file_Pool = read_file_Pool;
    }

    public static void setWrite_httpResponse_Pool(ThreadPoolExecutor write_httpResponse_Pool) {
        ThreadPools.write_httpResponse_Pool = write_httpResponse_Pool;
    }
