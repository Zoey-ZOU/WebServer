package com.zou.server.MultiThreadsServer;
...
public class LogGenerate {
    ...
    //日志的默认输出位置
    private static String location="C:\\Users\\surface\\Desktop\\web";
    //日志功能是否打开，默认打开
     ...
     * @param client  连接通道
     */
    public static void logger(LoggerType type, String content, Socket client) throws IOException {
        //用来存储连接后的日志信息
    ...
    public static void logGene(String logInfo){
        ...
        if(control.equals("open")){
            ...
            try{
                ...
                String log="多线程模型  Logger-Date：" + sdf.format(d);
