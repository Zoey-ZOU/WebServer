package com.zou.server.ThreadsPoolServer;
...
public class LogGenerate {
    ...
    //日志的默认输出位置
    private static String location="C:\\Users\\surface\\Desktop\\web\\ThreadsPool";
    //日志功能是否打开，默认打开
    ...
    protected static void logger(LoggerType type, String content, Socket client){
        ...
        try {
            ...
            LogGenerate.logGene("LOG_INFO:管道输出流异常");
            //e.printStackTrace();
        }
    }
    protected static void logGene(String logInfo){
        ...
        if(control.equals("open")){
            ...
            try{
                ...
                String log="线程池模型  Logger-Date：" + sdf.format(d);
